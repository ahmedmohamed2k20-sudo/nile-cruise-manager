  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (d != null) { setState(() { _selectedDate = d; provider.loadReservationsForDate(_selectedDate); }); }
                    },
                    child: Text(DateFormat('EEEE, MMMM d').format(_selectedDate), style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _l(Colors.green, 'Available'),
                  _l(Colors.amber, 'Reserved'),
                  _l(Colors.red, 'Past'),
                  _l(Colors.blue, 'Prep'),
                ],
              ),
        ...
        Positioned(
          bottom: 20, right: 20,
          child: FloatingActionButton(onPressed: () => _openAdd(null), backgroundColor: Colors.blue.shade700, child: const Icon(Icons.add, color: Colors.white, size: 30)),
        ),
      ],
    );
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(width: double.infinity, height: 50, child: ElevatedButton(
            ...
            child: const Text('Save Reservation', style: TextStyle(fontSize: 18)),
          )),
        ]),
      ),
    );
